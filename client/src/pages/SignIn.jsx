            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <div className="mt-6">
                    ...
                    <button
                        ...
                        className="mt-4 w-full flex items-center justify-center gap-3 px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors"
                    >
                ...
                <div className="mt-4 text-center text-sm text-gray-600">
                    Don't have an account? <Link to="/sign-up" className="text-indigo-600 hover:text-indigo-500">Sign Up</Link>
                </div>
            </div>
        </div>
    )
